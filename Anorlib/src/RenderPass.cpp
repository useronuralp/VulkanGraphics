...
namespace Anor
{
	RenderPass::RenderPass(const VkFormat& depthFormat)
	{
        // Color attachment
        VkAttachmentDescription colorAttachment{};
        colorAttachment.format = VulkanApplication::s_Surface->GetVKSurfaceFormat().format; // Format of the color attachment should match the swap chain image format.
