...
struct Utils
{
    ...
    static VkSampler CreateSampler(ImageType imageType, VkFilter magFilter, VkFilter minFilter, VkSamplerAddressMode addressMode, VkBool32 anisotrophy);
    ...
    static void SetObjectName(VkDevice device, uint64_t objectHandle, VkObjectType objectType, const char* name);
};
