...
class PhysicalDevice {
   ...
   public:
    const VkPhysicalDeviceProperties& GetVKProperties()
    {
        return m_Properties;
    }
    const VkPhysicalDeviceFeatures& GetVKFeatures()
    {
        return m_Features;
    }
    ...
    const VkPhysicalDeviceMemoryProperties& GetVKDeviceMemoryProperties()
    {
   ...
   private:
    ...
    std::vector<QueueFamily>   m_QueueFamilies; // Storing all the queue family
                                              // properties in this vector.
