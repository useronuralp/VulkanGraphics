...
private:
    ...
    void OnStart()
    {
        ...
        sausageModel   = new Model(std::string(SOLUTION_DIR) + "Engine\\models\\sausage\\scene.gltf", LOAD_VERTEX_POSITIONS | LOAD_NORMALS | LOAD_BITANGENT | LOAD_TANGENT | LOAD_UV, pool, layout);
