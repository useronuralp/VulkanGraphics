...
class Mesh {
   ...
   public:
    ...
    Ref<Image> GetNormals()
    {
        return m_Normals;
    }
    Ref<Image> GetRoughnessMetallic()
    {
   ...
   private:
    ...
    // Raw vertices and indices stored in a continues memory.
    // |_Vertex1(pos-normal-tangent-bitangent)__V2__V3__V4__...__Vn__|
