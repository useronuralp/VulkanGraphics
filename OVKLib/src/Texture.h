...
namespace OVK
{
	...
	public:
		...
		VkSampler CreateSamplerFromThisTexture(const VkDescriptorSet& dscSet, uint32_t bindingIndex, ImageType imageType = ImageType::COLOR);
	private:
		Ref<Image> m_Image;
	};
	...
	public:
		...
		VkSampler CreateSamplerFromThisTexture(const VkDescriptorSet& dscSet, uint32_t bindingIndex);
	private:
		Ref<Image> m_Image;
	};
}